...
const FIELDS: Field[] = [
  ...
  { key: "payment_iban", label: "IBAN", value: "ES•• •••• •••• •••• •••• 0294", x: 65.3, y: 61.6, w: 10.0, h: 1.8, size: 0.87, color: "#202124", bg: "adminonly" },
  { key: "payment_name", label: "Nombre titular", value: "Joel pedroche graciano", x: 65.3, y: 64.0, w: 9.0, h: 2.2, size: 0.78, color: "#5f6368", bg: "adminonly" },
